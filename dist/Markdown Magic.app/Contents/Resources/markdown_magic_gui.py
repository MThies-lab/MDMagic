#!/usr/bin/env python3
"""
EZ Markdown Converter - Simplified Single-File GUI Application
    ...
    def simple_convert_file(self, input_file, output_file):
        ...
        try:
            ...
            with open(output_file, 'w', encoding='utf-8') as f:
                ...
                f.write('converter: "EZ Markdown Converter"\n')
                f.write("---\n\n")
...
class EZMarkdownConverterWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("EZ Markdown Converter")
        ...
        # Application Title
        title_label = QLabel("EZ MARKDOWN CONVERTER")
        ...
        self.output_folder_label.setObjectName("info_label")
    ...
    def select_output_folder(self):
        ...
        if msg.clickedButton() == existing_btn:
            ...
            folder_name = "EZ_Markdown_Conversions"
...
def main():
    ...
    window = EZMarkdownConverterWindow()
    window.show()
