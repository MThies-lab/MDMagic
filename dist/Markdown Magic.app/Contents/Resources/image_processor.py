#!/usr/bin/env python3
"""
Image processing module for EZMDc
...
class ImageProcessor:
    ...
    def process_image(self, image_bytes, image_number, images_folder, position_info='', 
        ...
        """Process an image: convert to PNG, save, and generate OCR alt text"""
        try:
            ...
            return f"![{alt_text}]({images_folder}/image_{image_number}.png)"
    
    def create_markdown_placeholder(self, image_number, position_info, description, image_folder_name):
