...
# Launch the GUI
try:
    print("\n✓ Launching Markdown Magic GUI...")
    from markdown_magic_gui import main
    exit_code = main()
    sys.exit(exit_code)
except ImportError:
    # Fallback to the original GUI file if not renamed yet
    try:
        print("\n✓ Launching GUI (using markdown_magic_gui.py)...")
